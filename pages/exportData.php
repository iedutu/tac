			...
			<div class="card-header flex-wrap border-0 pt-6 pb-0">
				<div class="card-title">
					<h3 class="card-label">Report generation
							<span class="d-block text-muted pt-2 font-size-sm">Please select the dates for your reports or simply accept the default 6 months to date default interval..</span></h3>
				</div>
			</div>
