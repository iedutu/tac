...
<div id="contents">
	<div class="features">
		<br><br>
		<h1>Trucks summary</h1><h2>Click <a href="?page=cargo">here</a> for the cargo summary</h2>
...
$result = DB::query ( "SELECT * FROM cargo_truck WHERE 
						(
...
if ($result != null) {
	echo '
			<table width="1024" border="1" cellpadding="2" cellspacing="0" class="message">
	...
	echo '<h3>No available data found. Perhaps you should <a href="index.php?page=new">add a truck</a> record.</h3>';
}
?>
