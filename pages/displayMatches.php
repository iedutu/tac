...
<div class="card card-custom">
    <div class="card-header flex-wrap border-0 pt-6 pb-0">
        <div class="card-title">
            <h3 class="card-label">Summary
                <span class="d-block text-muted pt-2 font-size-sm">Please find below the list of trucks and cargo currently of interest.</span></h3>
        </div>
        <div class="card-toolbar d-print-none">
            <!--begin::Dropdown-->
            <div class="dropdown dropdown-inline mr-2">
                <!--begin::Button-->
                <a href="/?page=reports&data=matches" class="btn btn-light-primary font-weight-bolder <?=($_SESSION['operator']['reports']==0)?'disabled':''?>">
    ...
    <div class="card-body">
                        ...
                        <div class="col-md-2">
                            <div class="d-flex align-items-center">
                                ...
                                <select class="form-control" id="kt_datatable_search_status">
                                    ...
                                    <option value="<?=AppStatuses::$MATCH_FREE?>">Free</option>
                                    <option value="<?=AppStatuses::$MATCH_MARKET?>">Market</option>
                                    <option value="<?=AppStatuses::$MATCH_PARTIAL?>">Partially solved</option>
                                    <option value="<?=AppStatuses::$MATCH_SOLVED?>">Fully solved</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-2">
        ...
        <!--end: Search Form-->
        <!--begin: Datatable-->
        <?php DB_utils::generateMatches() // TODO: Come up with an optimization to avoid loading the entire table each time ?>
        <div class="datatable datatable-bordered datatable-head-custom" id="kt_datatable_matches_list"></div>
        <!--end: Datatable-->
    </div>
</div>
<!--end::Card-->
