...
<html lang="en">
	...
	<head><base href="">
		<meta charset="utf-8" />
		<title>ROHEL | Error | Page not found</title>
	...
	<!--end::Head-->
	<!--begin::Body-->
	<body id="kt_body" class="bg-white header-fixed header-mobile-fixed subheader-enabled aside-enabled aside-static page-loading">
		<!--begin::Main-->
			...
			<div class="d-flex flex-column-fluid flex-center">
				<div class="d-flex flex-center flex-column flex-lg-row p-10 p-lg-20">
					<div class="d-flex flex-column justify-content-center align-items-center align-items-lg-end flex-row-fluid order-2 order-lg-1">
						<!--begin::Content-->
						<h1 class="font-weight-boldest text-warning mb-5" style="font-size: 8rem">404</h1>
					...
					<img src="/assets/media/error/bg1.jpg" alt="image" class="w-100 w-sm-350px w-md-600px order-1 order-lg-2" />
				</div>
			</div>
			<!--end::Error-->
		</div>
