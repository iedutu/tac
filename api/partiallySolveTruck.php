...
if (!empty ( $_POST ['id'] )) {
    ...
    try {
        ...
        $email['subject'] = 'Truck order marked as partially loaded by ' . $recipient->getName();
        $email['title'] = 'ROHEL | E-mail';
        $email['header'] = 'A truck order was marked as partially loaded by ' . $recipient->getName();
