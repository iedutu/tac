							...
							<div class="container">
								...
								<div class="row">
									...
									<div class="col-lg-8">
										...
										<!--[html-partial:begin:{"id":"demo1/dist/inc/view/partials/content/widgets/charts/widget-2","page":"index"}]/-->
											...
											<div class="card-header h-auto border-0">
												...
												<div class="card-title py-5">
													<h3 class="card-label">
														...
														<span class="d-block text-muted mt-2 font-size-sm">More than 230+ new orders</span>
													</h3>
												</div>
												...
												<div class="d-flex align-items-center flex-wrap">
													<div class="d-flex align-items-center flex-grow-1 mr-2">
														<div class="d-flex align-items-center pr-10">
															<span class="label label-primary rounded h-4px w-15px mr-3"></span>
															<span class="font-weight-bold text-muted">Author</span>
														</div>
														<div class="d-flex align-items-center">
															<span class="label label-light-primary rounded h-4px w-15px mr-3"></span>
															<span class="font-weight-bold text-muted">Customer</span>
														</div>
													</div>
										...
										<!--[html-partial:end:{"id":"demo1/dist/inc/view/partials/content/widgets/charts/widget-2","page":"index"}]/-->
									</div>
								</div>
								...
								<div class="row">
									<div class="col-xxl-4">
										...
										<!--[html-partial:begin:{"id":"demo1/dist/inc/view/partials/content/widgets/mixed/widget-7","page":"index"}]/-->
										...
										<!--[html-partial:end:{"id":"demo1/dist/inc/view/partials/content/widgets/mixed/widget-7","page":"index"}]/-->
									</div>
									<div class="col-xxl-4">

										<!--[html-partial:begin:{"id":"demo1/dist/inc/view/partials/content/widgets/mixed/widget-8","page":"index"}]/-->
											...
											<div class="card-body d-flex flex-column pb-20">
												...
												<div class="flex-grow-1 pb-5">
													...
													<div class="d-flex align-items-center mb-6">
														...
														<div class="d-flex flex-wrap flex-row-fluid">
															...
															<div class="d-flex flex-column pr-5 flex-grow-1">
																<a href="#" class="text-dark-75 text-hover-primary mb-1 font-weight-bolder font-size-lg">Marcus Smart</a>
													...
													<div class="d-flex align-items-center mb-6">
														...
														<div class="d-flex flex-wrap flex-row-fluid">
															...
															<!--begin::Text-->
															<div class="d-flex flex-column pr-5 flex-grow-1">
																<a href="#" class="text-dark-75 text-hover-primary mb-1 font-weight-bolder font-size-lg">Andreas Hawks</a>
													...
													<div class="d-flex align-items-center">
														...
														<div class="d-flex flex-wrap flex-row-fluid">
															...
															<!--begin::Text-->
															<div class="d-flex flex-column pr-5 flex-grow-1">
																<a href="#" class="text-dark-75 text-hover-primary mb-1 font-weight-bolder font-size-lg">Sarah Connor</a>
												...
												<div class="progress-vertical min-h-150px flex-grow-1 border-bottom">
													<div class="text-center mr-1">
														<div class="progress bg-light-primary mb-4 mr-0 rounded-bottom-0" data-toggle="tooltip" title="40%">
															<div class="progress-bar bg-primary w-50px rounded-bottom-0" role="progressbar" style="height: 40%" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100"></div>
														</div>
														<span class="font-weight-bold font-size-lg text-muted">Q1</span>
													</div>
													<div class="text-center mx-1">
														<div class="progress bg-light-primary mb-4 mr-0 rounded-bottom-0" data-toggle="tooltip" title="65%">
															<div class="progress-bar bg-primary w-50px rounded-bottom-0" role="progressbar" style="height: 65%" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100"></div>
														</div>
														<span class="font-weight-bold font-size-lg text-muted">Q2</span>
													</div>
													<div class="text-center mx-1">
														<div class="progress bg-light-primary mb-4 mr-0 rounded-bottom-0" data-toggle="tooltip" title="50%">
															<div class="progress-bar bg-primary w-50px rounded-bottom-0" role="progressbar" style="height: 50%" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100"></div>
														</div>
														<span class="font-weight-bold font-size-lg text-muted">Q3</span>
													</div>
													<div class="text-center ml-1">
														<div class="progress bg-light-primary mb-4 mr-0 rounded-bottom-0" data-toggle="tooltip" title="80%">
															<div class="progress-bar bg-primary w-50px rounded-bottom-0" role="progressbar" style="height: 80%" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100"></div>
														</div>
										...
										<!--[html-partial:end:{"id":"demo1/dist/inc/view/partials/content/widgets/mixed/widget-8","page":"index"}]/-->
									</div>
									<div class="col-xxl-4">

										<!--[html-partial:begin:{"id":"demo1/dist/inc/view/partials/content/widgets/mixed/widget-9","page":"index"}]/-->
										...
										<!--[html-partial:end:{"id":"demo1/dist/inc/view/partials/content/widgets/mixed/widget-9","page":"index"}]/-->
									</div>
								</div>
								...
								<div class="row">
									<div class="col-xxl-4">
										...
										<div class="card card-custom card-stretch gutter-b">
											...
											<div class="card-header border-0 pt-6">
												<h3 class="card-title align-items-start flex-column">
													<span class="card-label font-weight-bolder font-size-h4 text-dark-75">Top Clients</span>
													<span class="text-muted mt-3 font-weight-bold font-size-lg">240,000 Total Sales</span>
												</h3>
												<div class="card-toolbar">
													<div class="dropdown dropdown-inline" data-toggle="tooltip" title="Quick actions" data-placement="left">
											...
											<div class="card-body pt-5">
												...
												<div class="d-flex flex-wrap align-items-center pb-2">
													...
													<!--begin::Icon-->
													<div class="symbol symbol-60 symbol-white">
														<span class="symbol-label d-flex justify-content-start w-45px ml-n1">
													...
													<div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 mr-2">
														...
														<span class="text-muted font-weight-bold">Oil &amp; Gas</span>
													</div>
												...
												<div class="d-flex flex-wrap align-items-center pb-2">
													...
													<div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 mr-2">
														...
														<span class="text-muted font-weight-bold">Cars, Bikes, Trucks</span>
													</div>
												...
												<div class="d-flex flex-wrap align-items-center pb-2">
													...
													<!--begin::Title-->
													<div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 mr-2">
														<a href="#" class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">Pythpn Inc.</a>
														<span class="text-muted font-weight-bold">Programming</span>
													</div>
												...
												<div class="d-flex flex-wrap align-items-center pb-2">
													...
													<!--begin::Title-->
													<div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 mr-2">
														<a href="#" class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">Beats Audio</a>
														<span class="text-muted font-weight-bold">Audio Industry</span>
													</div>
												...
												<div class="d-flex flex-wrap align-items-center">
													...
													<div class="symbol symbol-60 symbol-white">
														<span class="symbol-label d-flex justify-content-start w-45px ml-n1">
															<img src="assets/media/svg/misc/007-disqus.svg" class="h-50 align-self-center" alt="" />
														</span>
													</div>
													...
													<!--begin::Title-->
													<div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 mr-2">
														<a href="#" class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">Sass Tech.</a>
														<span class="text-muted font-weight-bold">CSS Solution</span>
													</div>
										...
										<div class="card card-custom card-stretch gutter-b">
											...
											<div class="card-header align-items-center border-0 mt-4">
												<h3 class="card-title align-items-start flex-column">
													...
													<span class="text-muted mt-3 font-weight-bold font-size-sm">445,634 Sales</span>
												</h3>
												<div class="card-toolbar">
													<div class="dropdown dropdown-inline" data-toggle="tooltip" title="Quick actions" data-placement="left">
														<a href="#" class="btn btn-icon-primary btn-clean btn-hover-light-primary btn-sm btn-icon" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
											...
											<div class="card-body pt-4">
												...
												<div class="timeline timeline-6 mt-3">
													...
													<div class="timeline-item align-items-start">
														...
														<!--begin::Label-->
														<div class="timeline-label font-weight-bolder text-dark-75 font-size-lg text-right pr-4">03:34</div>
														...
														<!--begin::Text-->
														<div class="timeline-content text-dark-50 pl-2">Outlines of the recent activities that happened last weekend</div>
													...
													<div class="timeline-item align-items-start">
														...
														<!--begin::Label-->
														<div class="timeline-label font-weight-bolder text-dark-75 font-size-lg text-right pr-4">5 hr</div>
														...
														<div class="timeline-content d-flex">
															<span class="mr-4 font-weight-bolder text-dark-75 pl-2">AEOL meeting with</span>
													...
													<div class="timeline-item align-items-start">
														...
														<!--begin::Label-->
														<div class="timeline-label font-weight-bolder text-dark-75 font-size-lg text-right pr-4">05:17</div>
														...
														<!--begin::Desc-->
														<div class="timeline-content font-weight-bolder text-dark-75 pl-2">Submit initial budget -
															<a href="#" class="text-primary">USD 300</a>.
														</div>
													...
													<div class="timeline-item align-items-start">
														...
														<!--begin::Label-->
														<div class="timeline-label font-weight-bolder text-dark-75 font-size-lg text-right pr-4">12:10</div>
														...
														<!--begin::Text-->
														<div class="timeline-content text-dark-50 pl-2">Stakeholder meeting scheduling.</div>
													...
													<div class="timeline-item align-items-start">
														...
														<!--begin::Label-->
														<div class="timeline-label font-weight-bolder text-dark-75 font-size-lg text-right pr-4">13:10</div>
														...
														<!--begin::Text-->
														<div class="timeline-content text-dark-50 pl-2">Project scoping &amp; estimations with stakeholders.</div>
													...
													<div class="timeline-item align-items-start">
														...
														<!--begin::Label-->
														<div class="timeline-label font-weight-bolder text-dark-75 font-size-lg text-right pr-4">22:43</div>
														...
														<!--begin::Desc-->
														<div class="timeline-content font-weight-bolder text-dark-75 pl-2">New order placed
															<a href="#" class="text-primary">#XF-4356</a>.
														</div>
													...
													<div class="timeline-item align-items-start">
														...
														<!--begin::Label-->
														<div class="timeline-label font-weight-bolder text-dark-75 font-size-lg text-right pr-4">19:07</div>
														...
														<!--begin::Text-->
														<div class="timeline-content text-dark-50 pl-2">Company BBQ to celebrate the last quater achievements and goals.</div>
								...
								<!--[html-partial:begin:{"id":"demo1/dist/inc/view/partials/content/widgets/tables/widget-4","page":"index"}]/-->
								...
								<!--[html-partial:end:{"id":"demo1/dist/inc/view/partials/content/widgets/tables/widget-4","page":"index"}]/-->
