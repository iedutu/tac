...
<div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
    ...
    <div class="offcanvas-header d-flex align-items-center justify-content-between pb-5">
        <h3 class="font-weight-bold m-0">Your account
            <?=DB_utils::notificationMessage()?></h3>
    ...
    <div class="offcanvas-content pr-5 mr-n5">
        ...
        <div class="d-flex align-items-center mt-5">
            ...
            <div class="d-flex flex-column">
                ...
                <div class="text-muted mt-1"><?=$_SESSION['operator']['country-name']?>, <?=$_SESSION['operator']['office-name']?> office</div>
                <div class="navi mt-1">
        ...
        <div class="navi navi-spacer-x-0 p-0">
            ...
            <span class="navi-item mt-2">
						<span class="navi-link">
							<a href="/?page=logout" class="btn btn-sm btn-light-primary font-weight-bolder py-3 px-6">Sign Out</a>
						</span>
					</span>
